...
#include <sstream>
#include <vector>
#include <algorithm> // Для функции remove_if
using namespace std;
...
bool isLongEnough(const string& word) {
...
int main() {
    ...
    cout << "Слова длиной не менее 7 символов были записаны в " << outputFileName << "\n";
    ...
    string outputWord;
    cout << "Слова длиной не менее 7 символов из файла " << outputFileName << ":\n";
    while (outputFileReader >> outputWord) {
        cout << outputWord << " ";
    }
